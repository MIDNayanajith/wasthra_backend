...
public function purchaseStore(Request $request)
{
    ...
    if ($purchase) {
        ...
        $materialsController->updateAvailableQuantity($request->material_name, $request->qty);
...
public function purchaseupdate(Request $request, int $purchase_id) {
    ...
    if ($validator->fails()) {
        ...
        if ($purchase) {
            ...
            // Update the available_qty in the Materials table
            $materialsController = new MaterialsController();
            $materialsController->updateAvailableQuantity($request->material_name, $qty_difference);
