...
Route::prefix('dashboard')->group(function () {
    Route::get('foodsale', [DashboardController::class, 'TotalFoodsale']);
    Route::get('itemsale', [DashboardController::class, 'TotalItemsale']);
    Route::get('totalsale', [DashboardController::class, 'saleTotalAmount']);
    Route::get('totalpurchase', [DashboardController::class, 'purchaseTotalAmount']);
    Route::get('totalcustomers', [DashboardController::class, 'TotalCustomers']);
});
